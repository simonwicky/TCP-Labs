...
def Lab6_Network():
    ...
    for r in routers:
        if daemons[0][k] == 1:
            r.cmd('zebra -d -f ' + dir_name + 'configs/' + 'zebra_r' +
                  str(k + 1) + '.cfg -i ' + dir_name + 'run/' + 'zebra_r' +
                  str(k + 1) + '.pid -z ' + dir_name + 'run/' + 'frr_r' +
                  str(k + 1) + '.api -u root -k')
        if daemons[1][k] == 1:
            r.cmd('bgpd -d -f ' + dir_name + 'configs/' + 'bgpd_r' +
                  str(k + 1) + '.cfg -i ' + dir_name + 'run/' + 'bgpd_r' +
                  str(k + 1) + '.pid -z ' + dir_name + 'run/' + 'frr_r' +
                  str(k + 1) + '.api -u root')
        if daemons[2][k] == 1:
            r.cmd('ospfd -d -f ' + dir_name + 'configs/' + 'ospfd_r' +
                  str(k + 1) + '.cfg -i ' + dir_name + 'run/' + 'ospfd_r' +
                  str(k + 1) + '.pid -z ' + dir_name + 'run/' + 'frr_r' +
                  str(k + 1) + '.api -u root')
        if daemons[3][k] == 1:
            r.cmd('ospf6d -d -f ' + dir_name + 'configs/' + 'ospf6d_r' +
                  str(k + 1) + '.cfg -i ' + dir_name + 'run/' + 'ospf6d_r' +
                  str(k + 1) + '.pid -z ' + dir_name + 'run/' + 'frr_r' +
                  str(k + 1) + '.api -u root')
        k = k + 1
