...
def firstNetwork():
    ...
    # h2.cmd('ip route add default via 10.5.0.100')  # should be 10.0.2.1
    h2.cmd('ip route add default via 10.0.2.1')  ### NEW
    #ipv6
    h2.cmd('ip -6 addr add 2020::2:2/112 dev h2-eth0')
    # h2.cmd('ip -6 route add default via 2020::10:2')  # should be 2020::2.1
    h2.cmd('ip -6 route add default via 2020::2:1')  ### NEW
    ...
    r1.cmd('echo 1 > /proc/sys/net/ipv4/ip_forward')  ### NEW
    r2.cmd('echo 1 > /proc/sys/net/ipv4/ip_forward')
    r3.cmd('echo 1 > /proc/sys/net/ipv4/ip_forward')
    #ipv6
    r1.cmd('echo 1 > /proc/sys/net/ipv6/conf/all/forwarding')  ### NEW
    ...
    r2.cmd('ip route add 10.0.1.0/24 via 10.0.5.1')  ### NEW
    r2.cmd('ip route add 10.0.2.0/24 via 10.0.5.1')  ### NEW
    r2.cmd('ip route add 10.0.4.0/24 via 10.0.6.2')  ### NEW
    r2.cmd('ip route add 10.0.7.0/24 via 10.0.6.2')  ### NEW
    ...
    r2.cmd('ip -6 route add 2020::1:0/112 via 2020::5:1')  ### NEW
    r2.cmd('ip -6 route add 2020::2:0/112 via 2020::5:1')  ### NEW
    r2.cmd('ip -6 route add 2020::4:0/112 via 2020::6:2')  ### NEW
    r2.cmd('ip -6 route add 2020::7:0/112 via 2020::6:2')  ### NEW
